...
class CustomCOCOeval:
                ...
                for m, maxDet in enumerate(m_list):
                    ...
                    for t, (tp, fp) in enumerate(zip(tp_sum, fp_sum)):
                        ...
                        try:
                            ...
                            print(
                                "Exception found. Printing something so bandit is not complaining..."
                            )
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            ###
            stats[9] = _summarize(
                0, iouThr=0.5, areaRng="small", maxDets=self.params.maxDets[2]
            )
            stats[10] = _summarize(
                0, iouThr=0.5, areaRng="medium", maxDets=self.params.maxDets[2]
            )
            stats[11] = _summarize(
                0, iouThr=0.5, areaRng="large", maxDets=self.params.maxDets[2]
            )
            ###
            return stats
